---
layout: post
title: "Stretto di Hormuz chiuso: le vulnerabilità delle supply chain europee settore per settore"
date: 2026-03-12
category: Geopolitica
tags: [Medio Oriente, Supply Chain, Commodities, Europa, Energia]
reading_time: "8 min"
...
In generale, gli analisti settoriali identificano tre vettori di rischio principali:

- **Interruzione dei flussi di commodity** — energia, metalli, fertilizzanti
- **Aumento dei noli marittimi** — con effetti a catena su supply chain complesse
- **Pressione sui margini** — le coperture (hedging) possono attenuare il colpo nel breve, ma non indefinitamente
...
Le riserve strategiche dei paesi OCSE (e della Cina) esistono esattamente per eventi come questo: è probabile un rilascio coordinato per soddisfare la domanda di raffinatori e consumatori finali.

Il gas naturale è più problematico: le scorte europee e asiatiche sono meno profonde rispetto al petrolio. La buona notizia è che siamo alla fine dell'inverno nell'emisfero nord, quindi la pressione stagionale è in calo.
...
Il punto critico: **una fonderia di alluminio spenta impiega 3-6 mesi per tornare a pieno regime**. Gli impatti sui prezzi potrebbero quindi protrarsi ben oltre la durata del conflitto.

### Rame
Non ci sono rischi immediati alla produzione, ma lo zolfo — sottoprodotto dell'oil & gas, usato nella produzione di acido solforico essenziale per la raffinazione del rame — è prodotto per circa un terzo nel Medio Oriente. Una carenza di zolfo si tramuterebbe in inflazione dei costi metallurgici.
...
### Acciaio
Il Medio Oriente produce circa l'1% delle unità ferro globali tramite il processo DRI (Direct Reduced Iron), con l'Iran come secondo produttore mondiale. L'impatto dovrebbe essere limitato dato l'eccesso di capacità esistente altrove.
...
- **Potassio**: circa il 10% della capacità globale è intorno al Mar Morto
- **Fosfati**: rischi sia logistici che di costo
...
Punti specifici:
- **Alluminio**: il Medio Oriente rappresenta circa il 10% dell'offerta globale; la chiusura dello Stretto impatta sia le importazioni di allumina/bauxite che le esportazioni di alluminio
